...
export class TwitterInteractionClient {
  ...
  async start() {
    ...
    console.log(parseInt(process.env.TWITTER_POLL_INTERVAL || "2") * 1000);
  }
  ...
  async getMentionCandidates() {
    ...
    const mentionCandidates = result.tweets;
  ...
  async handleTwitterInteractions() {
    ...
    const twitterUsername = process.env.TWITTER_USERNAME;
    try {
      const mentionCandidates = await this.getMentionCandidates();
      ...
      try {
        ...
        if (data.success) {
          ...
          response.text =
            ...
            `Manage your assets at X Wallet https://giftdrop.io/xwallet at #GiftDrop 👇 https://giftdrop.io/xwallet`;
        } else {
          console.log(
          ...
          response.text =
            ...
            `You may fund your wallet at GiftDrop xWallet https://giftdrop.io/xwallet https://giftdrop.io/xwallet`;
        }
